...
def generar_problema_88_2():
    ...
    while intentos < max_intentos:
        ...
        m = random.randint(2, 5)  # A es m veces B actualmente
        p = random.randint(m + 1, m + 3)  # Hace algunos años, A era p veces B
        ...
        if denominador != 0 and numerador % denominador == 0:
            ...
            if x > años_atras:  # La edad debe ser mayor que los años atrás
                A = m * x # Edad mayor
                if A > años_atras:
                    print("\n" + "=" * 80)
                    print("Autor: Samuel Lara Grandas")
                    print("Diciembre de 2025")
                    print("Ejercicio 88-2 (Adaptación)")
                    print("=" * 80)
                    print("Enunciado:")
