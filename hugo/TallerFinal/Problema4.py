...
def generar_problema_88_4():
    ...
    while intentos < max_intentos:
        # Generar números de personas aleatorios
        personas_inicial = random.randint(4, 10)
        personas_final = random.randint(2, personas_inicial - 1)
        
        # Asegurar que haya diferencia
        if personas_inicial <= personas_final:
            intentos += 1
            continue
            
        # Generar el monto adicional que cada uno debe poner
        adicional = random.randint(1000, 100000)
        adicional = (adicional // 1000) * 1000  # Redondear a miles
        ...
        if numerador % denominador == 0:
            ...
            print("Ejercicio 88-4 (Adaptación)")
            print("=" * 80)
            print("Enunciado:")
