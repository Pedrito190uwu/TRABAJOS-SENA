...
def generar_problema_88_26():
    ...
    while intentos < max_intentos:
        ...
        if denominador != 0 and numerador % denominador == 0:
            ...
            if x > 0:
                print("\n - Problema26.py:19" + "=" * 80)
                print("Autor: Samuel Lara Grandas - Problema26.py:20")
                print("Diciembre de 2025 - Problema26.py:21")
                print("Ejercicio 8817 (Adaptación) - Problema26.py:22")
                print("= - Problema26.py:23" * 80)
                print("Enunciado: - Problema26.py:24")
