...
def generar_problema_88_25():
    ...
    while intentos < max_intentos:
        ...
        multiplicador = random.randint(2, 5)  # B tiene X veces lo de A
        ...
        if numerador % denominador == 0 and numerador > 0:
            ...
            if 0 < x < d:
                ...
                print("\n - Problema25.py:25" + "=" * 80)
                print("Ejercicio 8825 - Problema25.py:26")
                print("= - Problema25.py:27" * 80)
                print("Enunciado: - Problema25.py:28")
