...
def generar_problema_88_10():
    ...
    while intentos < max_intentos:
        # Generar números aleatorios para la ecuación
        resta1 = random.randint(10, 50)
        resta2 = random.randint(10, 50)
        while resta2 == resta1:
            resta2 = random.randint(10, 50)
        
        # Generar multiplicadores aleatorios
        mult1 = random.randint(2, 20)
        mult2 = random.randint(2, 20)
        while mult2 == mult1:
            mult2 = random.randint(2, 20)
        
        # La ecuación es: (x - resta1) * mult1 = (x - resta2) * mult2
        # mult1*x - mult1*resta1 = mult2*x - mult2*resta2
        # mult1*x - mult2*x = mult1*resta1 - mult2*resta2
        # x*(mult1 - mult2) = mult1*resta1 - mult2*resta2
        # x = (mult1*resta1 - mult2*resta2) / (mult1 - mult2)
        ...
        if denominador != 0 and numerador % denominador == 0:
            ...
            # Asegurar que x sea positivo y mayor que las restas
            if x > max(resta1, resta2):
                print("\n - Problema10.py:35" + "=" * 80)
                print("Autor: Samuel Lara Grandas - Problema10.py:36")
                print("Diciembre de 2025 - Problema10.py:37")
                print("Ejercicio 8810 (Adaptación) - Problema10.py:38")
                print("= - Problema10.py:39" * 80)
                print("Enunciado: - Problema10.py:40")
